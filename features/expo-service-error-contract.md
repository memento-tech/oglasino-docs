...
Status: `shipped (code)`. On-device airplane-mode verification deferred to the Ψ chat. The iOS+Android rebuild bundling the netinfo native module has landed (2026-06-01), so this Ψ is no longer blocked on a build — it is unblocked, awaiting Igor running it on device. See [decisions.md](../decisions.md) 2026-05-29 Φ4 entry.
